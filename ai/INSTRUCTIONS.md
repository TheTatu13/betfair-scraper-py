...
This scraper extracts job listings for **BETFAIR ROMANIA DEVELOPMENT SRL** (CIF: 22201773) from
the company's own careers site, validates the company via ANAF, and imports
the jobs to peviitor.ro.

Targets: https://www.betfairromania.ro/jobs, 
...
- **Betfair — listing**: `https://www.betfairromania.ro/jobs` — pagina publică de posturi deschise
- **Betfair — sitemap**: `` — permalink-uri canonice
