...
Fill this in per derived company. Check `https://www.betfairromania.ro/robots.txt` before the
...
| Path | Role |
|---|---|
| `https://www.betfairromania.ro/jobs` | Public list of open positions (server-rendered HTML) |
| `` | Job sitemap — canonical `https://www.betfairromania.ro/jobs/<slug>/` permalinks |
| `https://www.betfairromania.ro/jobs/<slug>/` | Individual job pages (only referenced, not fully crawled) |
